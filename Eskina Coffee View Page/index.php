...
<body>
    ...
    <img src="images/image1.jpg" alt="Eskina">
    ...
    <div class="story-image">
        <img src="images/image2.jpg" alt="Eskina" id="about">
    </div>
    ...
    <section class="menu-categories" id="menu">
        ...
        <div class="menu-items">
            ...
            <div class="menu-item">
                ...
                <a href="menu.php?category=foods-wraps-and-sandwiches" class="btn2">WRAPS AND SANDWICHES</a>
            </div>
    ...
    <div class="contact-image">
        ...
        <div class="contact-text">
            ...
            <h3>Opening Hours</h3>
            <p> Sunday - Thursday | 1:00 PM - 11:00 PM </br>
                Friday - Saturday | 1:00 PM - 12:00 AM </p>
